...
public class TokenHelper {
	...
	public String generateToken(String username, Device device, Long id, Collection<? extends GrantedAuthority> auth, String fullName) {
		...
		return Jwts.builder().setIssuer(APP_NAME).setClaims(claims).setSubject(username).setAudience(audience)
